...
```javascript
resolveKernel = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-kernels-generic-unary-strided1d-unblocked@umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var resolveKernel = require( 'path/to/vendor/umd/ndarray-base-kernels-generic-unary-strided1d-unblocked/index.js' )
```
