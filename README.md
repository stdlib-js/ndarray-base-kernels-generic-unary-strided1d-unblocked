...
```javascript
import kernel from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-kernels-generic-unary-strided1d-unblocked@esm/index.mjs';
```

You can also import the following named exports from the package:

```javascript
import { kernel0d, kernel10d, kernel1d, kernel2d, kernel3d, kernel4d, kernel5d, kernel6d, kernel7d, kernel8d, kernel9d } from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-kernels-generic-unary-strided1d-unblocked@esm/index.mjs';
```
